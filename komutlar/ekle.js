module.exports = {
  ...
  $channelSendMessage[$getServerVar[yetkililog];<@$authorID>,<@&$getServerVar[yetkilirol]> {author:$userTag:$authorAvatar}{description:<@$authorID> Adlı üye **$userTag[$message[1]]( \`$message[1]\` )** adlı botu ile başvurdu
